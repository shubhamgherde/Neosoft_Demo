...
public interface DeptRequestRepository extends JpaRepository<Dept_request, Integer> {
	...
	@Query(value = "select * from dept_request where department=:department && role='[USER]'", nativeQuery = true)
	public List<Dept_request> userAllDeptReq(@Param("department") String department);
