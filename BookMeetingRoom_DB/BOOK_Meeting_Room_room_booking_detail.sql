...
CREATE TABLE `room_booking_detail` (
  ...
  `booking_date_from` varchar(100) DEFAULT NULL,
  `booking_date_to` varchar(100) DEFAULT NULL,
...
LOCK TABLES `room_booking_detail` WRITE;
/*!40000 ALTER TABLE `room_booking_detail` DISABLE KEYS */;
/*!40000 ALTER TABLE `room_booking_detail` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-11-21 13:12:36
